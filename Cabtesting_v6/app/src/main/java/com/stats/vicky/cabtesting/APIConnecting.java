...
public class APIConnecting extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... arg) {
        ...
        try {
            ...
            else if (arg[0]=="cncl_dtls") {
                url = new URL("http://106.51.155.80:90/cab/TripDetails/TripCancellation.php"); // here is your URL path
                postDataParams.put("UserName", arg[1]);

            }
            else if ( arg[0]=="trip_dtls") {
                url = new URL("http://106.51.155.80:90/cab/TripDetails/TripInfo.php"); // here is your URL path
                postDataParams.put("UserName", arg[1]);

            }
            else if ( arg[0]=="cncl_dtls_n") {
                url = new URL("http://106.51.155.80:90/cab/TripDetails/TripCancellation.php"); // here is your URL path
                postDataParams.put("UserName", arg[1]);
    ...
    protected void onPostExecute(String result) {
        ...
        else if (result_data[0].equals("cncl_dtls_n"))
        {
